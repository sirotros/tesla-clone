  ...
  return (
    <footer className={s.footer}>
      <ul className={s.footerList}>
        ...
        <li className={`${s.footerListItem} ${s.phoneOnly}`}><a href="#">Contact</a></li>
        <li className={`${s.footerListItem}`}><a href="#">Carerrs</a></li>
        <li className={`${s.footerListItem}`}><a href="#">News</a></li>
        <li className={`${s.footerListItem} ${s.phoneOnly}`}><a href="#">Engage</a></li>
        <li className={`${s.footerListItem} ${s.phoneOnly}`}><a href="#">Locations</a></li>
      </ul>
    </footer>
  )
}
